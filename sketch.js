...
function setup() {
  ...
  hero = new Hero(700,300,500);

  fly = new Fly(hero.body,{x:50,y:50})

  block1 = new Block(2000,100,50,100);

  block2 = new Block(2000,200,50,100);

  block3 = new Block(2000,300,50,100);

  block4 = new Block(2000,400,50,100);
